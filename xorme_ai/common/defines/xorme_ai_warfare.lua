...
NDefines.NAI.ARMY_DISTANCE_SCORE_IMPACT	= 1.0
...
--
NDefines.NAI.TRANSPORT_FRACTION = 0.275
NDefines.NAI.BIGSHIP_FRACTION = 0.235
NDefines.NAI.OVER_FORCELIMIT_AVOIDANCE_FACTOR = 45
